...
def get_preprocessed_custom(dataset_config, tokenizer, split):
    dataset = datasets.load_dataset("csv", data_files="../llama-3.1-8b/chatbot_datasets/Datasets_17k_balance_10fold/train/augmented_train_split/Datasets_17k_augmented_train_10fold_3.csv", split='train')
