...
def get_preprocessed_custom(dataset_config, tokenizer, split):
    dataset = datasets.load_dataset("csv", data_files="../llama3.1-8b/RaC-Datasets/Datasets_17k_balance_10fold/train/augmented_x24_train_split/Datasets_17k_augmented_train_10fold_1.csv", split='train', encoding = "utf-8")
